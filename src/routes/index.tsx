      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <header className="flex flex-col items-center justify-center mb-16 space-y-8">
          <div className="flex flex-col items-center space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-center bg-gradient-to-b from-white to-neutral-500 bg-clip-text text-transparent">
        ...
        {playlist ? (
                  ...
                  >
                    ...
                    <div className="relative aspect-video bg-neutral-900 overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
                        <div className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white shadow-lg ring-1 ring-white/20 transform scale-75 group-hover:scale-100 transition-transform duration-300">
          ...
          <div className="flex flex-col items-center justify-center py-20 space-y-4 animate-in fade-in duration-1000 fill-mode-both delay-200">
